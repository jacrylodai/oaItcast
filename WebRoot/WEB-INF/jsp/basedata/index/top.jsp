	...
	<div id="Head1">
		...
		<div id="Head1Right">
			<div id="Head1Right_UserName">
                <img border="0" width="13" height="14" src="style/images/top/user.gif" /> 您好，<b><s:property value="#session['userSessionId'].username"/></b>
			</div>
        ...
        <div id="Head1Right_SystemButton">
            <a target="_parent" href="basedata/login/loginAction_logout.action">
