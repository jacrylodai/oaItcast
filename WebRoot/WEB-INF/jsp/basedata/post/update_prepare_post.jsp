...
<!--显示表单内容-->
<div id="MainArea">
    <s:form action="postAction_updatePost" namespace="/basedata/post" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td><s:textfield name="postName" cssClass="InputStyle"></s:textfield> *</td>
                    </tr>
                    <tr>
                        <td>岗位说明</td>
                        <td><s:textarea name="postDesc" cssClass="TextareaStyle"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
